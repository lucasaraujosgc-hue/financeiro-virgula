...
import { Plus, Power, Edit2, X, Check } from 'lucide-react';
            ...
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full ${bank.active ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-500'}`}>
          ...
          <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSaveBank} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                 ...
                 >
                    <Power size={16} />
                    {editingBank.active ? 'Conta Ativa' : 'Conta Inativa'}
                 </button>
              </div>
