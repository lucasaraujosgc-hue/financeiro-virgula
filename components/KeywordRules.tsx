...
import { Category, TransactionType, KeywordRule, CategoryType } from '../types';
...
const KeywordRules: React.FC<KeywordRulesProps> = ({ categories, rules, onAddRule, onDeleteRule }) => {
          ...
          <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
                  <thead className="bg-slate-950 text-slate-400 font-medium border-b border-slate-800">
                      <tr>
                          <th className="px-6 py-4">Quando descrição conter...</th>
                          <th className="px-6 py-4">E for do tipo...</th>
                          <th className="px-6 py-4">Vincular à Categoria</th>
                          <th className="px-6 py-4 text-center">Ações</th>
                      </tr>
                  </thead>
                  <tbody className="divide-y divide-slate-800">
                      {filteredRules.length === 0 ? (
                          <tr><td colSpan={4} className="text-center py-8 text-slate-500">Nenhuma regra encontrada.</td></tr>
                      ) : (
